        ...
        switch (ingredientType)
        {
                ...
                if (isPushEvent)
                {
                    switch (nameObject_This)
                    {
                        case NameObject_This.LionClothMachine:
                            EnventManager.TriggerEvent(EventName.LionHabitat_OnComplete.ToString());
                            break;
                    }
                }
                break;
                ...
                if (isPushEvent)
                {
                    switch (nameObject_This)
                    {
                        case NameObject_This.CrocClothMachine:
                            EnventManager.TriggerEvent(EventName.CrocHabitat_OnComplete.ToString());
                            break;
                    }
                }
                break;
                ...
                if (isPushEvent)
                {
                    switch (nameObject_This)
                    {
                        case NameObject_This.EleClothMachine:
                            EnventManager.TriggerEvent(EventName.EleHabitat_OnComplete.ToString());
                            break;
                    }
                }
                break;
            case IngredientType.ZEBRA:
                if (!levelManager.machineManager.listZebraClothMachineActive.Contains(this))
                    levelManager.machineManager.listZebraClothMachineActive.Add(this);
                if (isPushEvent)
                {
                    switch (nameObject_This)
                    {
                        case NameObject_This.ZebraClothMachine:
                            EnventManager.TriggerEvent(EventName.ZebraHabitat_OnComplete.ToString());
                            break;
                    }
                }
                break;
