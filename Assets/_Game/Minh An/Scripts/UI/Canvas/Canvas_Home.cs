...
public class Canvas_Home : UI_Canvas
{
    ...
    [SerializeField] private Button btn_Maps;
    ...
    public override void OnInIt()
    {
        ...
        btn_Maps.onClick.AddListener(Open_Maps);
        NotShow_Btn_Oder();
        Show_Btn_Upgrade();
    ...
    {
        UI_Manager.Instance.OpenUI(NameUI.Canvas_Maps);
    }
    ...
    public void Show_Btn_Maps()
    {
        btn_Maps.gameObject.SetActive(true);
    }
    public void NotShow_Btn_Maps()
    {
        btn_Maps.gameObject.SetActive(false);
    }
